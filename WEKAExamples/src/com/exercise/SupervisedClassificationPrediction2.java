...
public class SupervisedClassificationPrediction2 {
	public static void main(String[] args) throws Exception{
		...
		DataSource source2 = new DataSource("C:\\MyFolder\\iris-unknown.arff");
		...
		saver.setFile(new File("C:\\MyFolder\\iris-new.arff"));
		saver.writeBatch();
